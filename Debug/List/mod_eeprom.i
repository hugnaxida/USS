...
bool_t Eeprom_Init(Meas_uMeasurementParameters_t* measParameter)
{
  ...
  if(((void *)0) != measParameter)
  {
    ...
    loc_pEepromAppData = (Meas_uMeasurementParameters_t*)(0x48000000u);
  ...
  else
  {
    ...
    retval = 0;
    err_ErrorHandlerExt(142, ERR_MODLIST_EEPROM);;
  }
  return retval;
}
...
Meas_uMeasurementParameters_t* Eeprom_GetDataPointer(void)
{
  return (Meas_uMeasurementParameters_t*)(0x48000000u);
}
...
void Eeprom_Task(void)
{
  if((((void *)0) != loc_pAppData) && (((void *)0) != loc_pEepromAppData))
  {
    switch(loc_Action)
    {
  ...
  else
  {
    ...
    err_ErrorHandlerExt(208, ERR_MODLIST_EEPROM);;
  }
}
...
void loc_CopyEepromToRam(void)
{
  if((((void *)0) != loc_pAppData) && (((void *)0) != loc_pEepromAppData))
  {
    ...
    for(uint32_t i = 0; i < ((5u) + (2u) + (3*(11u)) + (2*(14u)) + (2u) + (2u) + (11u) + (2u) + (4u) + (10u) + (3u) + (2u)); i++)
    {
      loc_pAppData->halfwords[i] = loc_pEepromAppData->halfwords[i];
    }
    /* calculate crc over ram and compare to crc saved in ram */
    bool_t retval = crc16_checkCrc((uint32_t)loc_pAppData, (198u), loc_pAppData->data.CrcCalculation.fields.CrcEepromOrRam, ((void *)0));
    if(1 == retval)
    {
      /* everything ok */
    }
  ...
  else
  {
    ...
    err_ErrorHandlerExt(403, ERR_MODLIST_EEPROM);;
  }
}
...
void loc_CopyRamToEeprom(void)
{
  if((((void *)0) != loc_pAppData) && (((void *)0) != loc_pEepromAppData))
  {
    ...
    ret = eeprom_Write(0xA509u, (eeprom_cpData_t)loc_pAppData, (eeprom_Address_t)loc_pEepromAppData, (208u), 0, 0);
    if(ret != 1)
    {
    ...
    else
    {
      ...
      ret = crc16_checkCrc((uint32_t)loc_pEepromAppData, (198u), loc_pEepromAppData->data.CrcCalculation.fields.CrcEepromOrRam, ((void *)0));
      if(1 == ret)
      {
        /* everything ok */
      }
  ...
  {
    /* init not completed -> goto error handler */
    err_ErrorHandlerExt(446, ERR_MODLIST_EEPROM);;
  }
}
...
void loc_CopySlaveIdToEeprom(void)
{
  if((((void *)0) != loc_pAppData) && (((void *)0) != loc_pEepromAppData))
  {
    ...
    ret = eeprom_Write(0xA509u, (eeprom_cpData_t)(&(loc_pAppData->data.SlaveId.halfwords[0])), (eeprom_Address_t)(&(loc_pEepromAppData->data.SlaveId.halfwords[0])), 4, 0, 0);
    if(ret != 1)
    {
      /* eeprom write failed -> set HwErrFlag */
      err_SetHwErrorFlag(ERR_EEPROM_PROGRAMMING_FAILURE, ERR_NO_ERROR2);
  ...
  {
    /* init not completed -> goto error handler */
    err_ErrorHandlerExt(478, ERR_MODLIST_EEPROM);;
  }
}
