...
bool_t meas_init(void)
{
  ...
  retval = retval && swtimer_RegisterCustomZeroCountInterruptCallback(swtimer_eTimer_0, meas_TickTimer_ISR);
  retval = retval && swtimer_RegisterCustomZeroCountInterruptCallback(swtimer_eTimer_1, meas_SyncTimer_ISR);
...
void meas_AbortMeasurement(void)
{
  ...
  loc_AppRtData.RuntimeData.MeasAbortFlag = 1;
}
...
void meas_SyncTimer_ISR(swtimer_eInterruptVectorNum_t sno,  swtimer_pInterruptContextData_t contextdata)
{
  ((((SWTIMER_Type *) 0x50000100UL)->IRQ_MASK . reg) &= ~(1u << (0x0FU & (uint16_t)(swtimer_IRQ_EVT_CNT_ZERO_1))));
  ((((SWTIMER_Type *) 0x50000100UL)->IRQ_VNO . reg) = (swtimer_eInterruptVectorNum_t)(swtimer_IRQ_EVT_CNT_ZERO_1));
  ((((SWTIMER_Type *) 0x50000100UL)->CONFIG . reg) &= ~(1u << (0x03U & (uint16_t)(swtimer_eTimer_1))));
  ...
  case meas_eMeas_STATE_PRE_ECHO_MEAS:
    ...
    if(1 == loc_AppRtData.Results.LabModeRuntimeData.IsInitialised)
    {
      ...
      if((0 == loc_AppRtData.Results.LabModeRuntimeData.IsRunning) && (0 == loc_AppRtData.Results.LabModeRuntimeData.IsFinished)
    ...
    ((((BRG_Type *) 0x50000300UL)->BRG_CTRL . bit). burst_en = (1u));

    /* compensate first 32us isr timer tick in burst-length monitoring see SM10 */
    if((1u) == ((brg_BurstStatus_t)(((BRG_Type *) 0x50000300UL)->BRG_CTRL . bit). burst_sta) )
    {
...
void meas_TickTimer_ISR(swtimer_eInterruptVectorNum_t sno,  swtimer_pInterruptContextData_t contextdata)
{
  ...
  if ( (0x07FFu) != ((((DSP_Type *) 0x50000400UL)->MT . reg)) )
  {
    ...
    loc_AppRtData.Results.SyncedMeasurementTime = (((((DSP_Type *) 0x50000400UL)->MT . reg))>>5u)+1u;
  }
  else
  {
  ...
  case meas_eMeas_STATE_ECHO_MEAS:
    ...
    if (0 == loc_AppRtData.Results.LabModeRuntimeData.IsInitialised)
    {
  ...
  case meas_eMeas_STATE_POST_LAB:
      /* stop timer */
      ((((SWTIMER_Type *) 0x50000100UL)->IRQ_MASK . reg) &= ~(1u << (0x0FU & (uint16_t)(swtimer_IRQ_EVT_CNT_ZERO_0))));
      ((((SWTIMER_Type *) 0x50000100UL)->IRQ_VNO . reg) = (swtimer_eInterruptVectorNum_t)(swtimer_IRQ_EVT_CNT_ZERO_0));
      ((((SWTIMER_Type *) 0x50000100UL)->CONFIG . reg) &= ~(1u << (0x03U & (uint16_t)(swtimer_eTimer_0))));
    break;
...
void loc_StartSyncTimerForEchoMeas(void)
{
   ...
   */
  (*(&(((SWTIMER_Type *) 0x50000100UL)->CNT0_RELOAD . reg) + (swtimer_eTimer_1)) = (uint16_t)(0xFFFF));
  ((((SWTIMER_Type *) 0x50000100UL)->COMMAND . reg) = (1u << (swtimer_eTimer_1)) | (1u << ((swtimer_eTimer_1) + 2u)));
  ((((SWTIMER_Type *) 0x50000100UL)->CONFIG . reg) |= (1u << (0x03U & (uint16_t)(swtimer_eTimer_1))));

  uint16_t timerReloadValForEchoStart = (512u) + (loc_AppRtData.Parameters.data.NoiseMeasurement.fields.NoiseMeasTime * (32u))                                         + (768u) - (12u);
  if ( (2800) < (int32_t)( timerReloadValForEchoStart - ((((DSI3_Type *) 0x50000200UL)->TIMER_COUNTER . reg)) ) ) /* todo: 2600us typical time to get to Task until meas_eMeas_STATE_PRE_ECHO_MEAS is reached */
  {
    (*(&(((SWTIMER_Type *) 0x50000100UL)->CNT0_RELOAD . reg) + (swtimer_eTimer_1)) = (uint16_t)(timerReloadValForEchoStart - ((((DSI3_Type *) 0x50000200UL)->TIMER_COUNTER . reg))));
    ((((SWTIMER_Type *) 0x50000100UL)->COMMAND . reg) = (1u << (swtimer_eTimer_1)) | (1u << ((swtimer_eTimer_1) + 2u)));
  ...
  else
  {
    ...
    (*(&(((SWTIMER_Type *) 0x50000100UL)->CNT0_RELOAD . reg) + (swtimer_eTimer_1)) = (uint16_t)(timerReloadValForEchoStart));
    ((((SWTIMER_Type *) 0x50000100UL)->COMMAND . reg) = (1u << (swtimer_eTimer_1)) | (1u << ((swtimer_eTimer_1) + 2u)));
    ((((SWTIMER_Type *) 0x50000100UL)->IRQ_MASK . reg) |= (1u << (0x0FU & (uint16_t)(swtimer_IRQ_EVT_CNT_ZERO_1))));
  }
...
void loc_StartSyncTimerForPostMaskingTime(void)
{
  ...
  if(0 != loc_AppRtData.RuntimeData.MaskingTime)
  {
    ...
    (*(&(((SWTIMER_Type *) 0x50000100UL)->CNT0_RELOAD . reg) + (swtimer_eTimer_1)) = (uint16_t)(loc_AppRtData . RuntimeData . MaskingTime * (32u)));
    ((((SWTIMER_Type *) 0x50000100UL)->IRQ_MASK . reg) |= (1u << (0x0FU & (uint16_t)(swtimer_IRQ_EVT_CNT_ZERO_1))));
    ((((SWTIMER_Type *) 0x50000100UL)->CONFIG . reg) |= (1u << (0x03U & (uint16_t)(swtimer_eTimer_1))));
    ((((SWTIMER_Type *) 0x50000100UL)->COMMAND . reg) = (1u << (swtimer_eTimer_1)) | (1u << ((swtimer_eTimer_1) + 2u)));
  }
  else
  {
    ...
    meas_SyncTimer_ISR(swtimer_IRQ_EVT_CNT_ZERO_0, (swtimer_pInterruptContextData_t) ((void *)0));
  }
}
...
void meas_StartTickTimerForNoiseMeas(void)
{
   ...
   */
  (*(&(((SWTIMER_Type *) 0x50000100UL)->CNT0_RELOAD . reg) + (swtimer_eTimer_0)) = (uint16_t)((32u)-1));
  ((((SWTIMER_Type *) 0x50000100UL)->IRQ_MASK . reg) |= (1u << (0x0FU & (uint16_t)(swtimer_IRQ_EVT_CNT_ZERO_0))));
  ((((SWTIMER_Type *) 0x50000100UL)->CONFIG . reg) |= (1u << (0x03U & (uint16_t)(swtimer_eTimer_0))));
  ((((SWTIMER_Type *) 0x50000100UL)->CONFIG . reg) |= (uint16_t)(1L<<(swtimer_eTimer_0))<<2u);
  ((((SWTIMER_Type *) 0x50000100UL)->COMMAND . reg) = (1u << (swtimer_eTimer_0)) | (1u << ((swtimer_eTimer_0) + 2u)));
}
...
void loc_TaskState_INIT(void)
{
  ...
  /* reset abort flag */
  loc_AppRtData.RuntimeData.MeasAbortFlag = 0;
...
void loc_TaskState_INIT_Com(void)
{
  ...
  (((DSP_Type *) 0x50000400UL)->ASP_CTRL . bit).g_ana_diag = 0;
  loc_readBackAfterWrite((((DSP_Type *) 0x50000400UL)->ASP_CTRL . bit).g_ana_diag, 0);
    (((DSP_Type *) 0x50000400UL)->ASP_CTRL . bit).g_ana      = loc_AppRtData.Parameters.data.GeneralSettings.fields.AnalogGain;
    loc_readBackAfterWrite((((DSP_Type *) 0x50000400UL)->ASP_CTRL . bit).g_ana, loc_AppRtData.Parameters.data.GeneralSettings.fields.AnalogGain);
  (((DSP_Type *) 0x50000400UL)->ASP_CTRL . bit).fc_x2      = loc_AppRtData.Parameters.data.GeneralSettings.fields.AnalogLp;
  loc_readBackAfterWrite((((DSP_Type *) 0x50000400UL)->ASP_CTRL . bit).fc_x2, loc_AppRtData.Parameters.data.GeneralSettings.fields.AnalogLp);
  /* configure burst generator */
  uint16_t f_c = 0;
  
    /* compensate of f0 */
    f_c = (loc_AppRtData.Parameters.data.GeneralSettings.fields.SamplingFrequency * (768u)) / Dsi3DrvImp_HWModIfFuns->Get1usClockCfg();
  (((BRG_Type *) 0x50000300UL)->BRG_FC . bit).f_c              = f_c;
  loc_readBackAfterWrite((((BRG_Type *) 0x50000300UL)->BRG_FC . bit).f_c, f_c);
  /* configure burst generator -> transducer driver */
  (((BRG_Type *) 0x50000300UL)->TDR_CTRL . bit).sel_isrc   = 0;
  loc_readBackAfterWrite((((BRG_Type *) 0x50000300UL)->TDR_CTRL . bit).sel_isrc, 0);
  (((BRG_Type *) 0x50000300UL)->TDR_CTRL . bit).i_drv      = loc_AppRtData.Parameters.data.GeneralSettings.fields.TdrCurrent;
  loc_readBackAfterWrite((((BRG_Type *) 0x50000300UL)->TDR_CTRL . bit).i_drv, loc_AppRtData.Parameters.data.GeneralSettings.fields.TdrCurrent);
  /* configure dsp -> ringing frequency measurement */
  (((DSP_Type *) 0x50000400UL)->RFM_CTRL . bit).rfm_start  = loc_AppRtData.Parameters.data.GeneralSettings.fields.RingFreqStart;
  loc_readBackAfterWrite((((DSP_Type *) 0x50000400UL)->RFM_CTRL . bit).rfm_start, loc_AppRtData.Parameters.data.GeneralSettings.fields.RingFreqStart);
  (((DSP_Type *) 0x50000400UL)->RFM_CTRL . bit).rfm_width  = loc_AppRtData.Parameters.data.GeneralSettings.fields.RingFreqWidth;
  loc_readBackAfterWrite((((DSP_Type *) 0x50000400UL)->RFM_CTRL . bit).rfm_width, loc_AppRtData.Parameters.data.GeneralSettings.fields.RingFreqWidth);
    /* configure dsp -> envelope processor */
    (((DSP_Type *) 0x50000400UL)->ENVP_CFG . bit).g_cal      = loc_AppRtData.Parameters.data.GeneralSettings.fields.CalibrationGain;
    loc_readBackAfterWrite((((DSP_Type *) 0x50000400UL)->ENVP_CFG . bit).g_cal, loc_AppRtData.Parameters.data.GeneralSettings.fields.CalibrationGain);
  /* configure DAC */
  (((DAC_CTRL_Type *) 0x50000600UL)->CTRL . bit).dac0_cfg   = loc_AppRtData.Parameters.data.GeneralSettings.fields.Dac0Ctrl; 
  loc_readBackAfterWrite((((DAC_CTRL_Type *) 0x50000600UL)->CTRL . bit).dac0_cfg, loc_AppRtData.Parameters.data.GeneralSettings.fields.Dac0Ctrl);
  (((DAC_CTRL_Type *) 0x50000600UL)->CTRL . bit).dac1_cfg   = loc_AppRtData.Parameters.data.GeneralSettings.fields.Dac1Ctrl;
  loc_readBackAfterWrite((((DAC_CTRL_Type *) 0x50000600UL)->CTRL . bit).dac1_cfg, loc_AppRtData.Parameters.data.GeneralSettings.fields.Dac1Ctrl);
...
void loc_TaskState_INIT_Std(void)
{
  bool_t execute = 1;/*-?|AP5|wladimir.pauls|c2|?*/
  ...
  case meas_eMeasProfile_PROFILEA:
    ...
    {
      loc_AppRtData.RuntimeData.Meas_time = (0xFFFFu);
    }
    else
    {
  ...
  if(1 == execute)
  {
     ...
     */
    /* configure burst generator */
    (((BRG_Type *) 0x50000300UL)->BRG_CFG . bit).burst_type        = 0;
    loc_readBackAfterWrite((((BRG_Type *) 0x50000300UL)->BRG_CFG . bit).burst_type, 0);
    (((BRG_Type *) 0x50000300UL)->BRG_CFG . bit).n_pulses          = loc_pParam->fields.SpxBurstPulses;
    loc_readBackAfterWrite((((BRG_Type *) 0x50000300UL)->BRG_CFG . bit).n_pulses, loc_pParam->fields.SpxBurstPulses);
    uint16_t f_0;
    if(0 != loc_AppRtData.Parameters.data.DsiSettings.fields.SyncFreq)
    {
      /* compensate of f0 */
      f_0 = loc_pParam->fields.SpxBurstFreq * (768u) / Dsi3DrvImp_HWModIfFuns->Get1usClockCfg();
    }
    else
    {
    ...
    ((((BRG_Type *) 0x50000300UL)->BRG_F0 . bit). f_0 = (f_0));
    loc_readBackAfterWrite(((((BRG_Type *) 0x50000300UL)->BRG_F0 . bit). f_0), f_0);
    /* configure dsp -> envelope processor */
    (((DSP_Type *) 0x50000400UL)->ENVP_CFG . bit).fspi_sel         = 1;
    loc_readBackAfterWrite((((DSP_Type *) 0x50000400UL)->ENVP_CFG . bit).fspi_sel, 1);
    (((DSP_Type *) 0x50000400UL)->ENVP_CFG . bit).envp_afc         = 1;
    loc_readBackAfterWrite((((DSP_Type *) 0x50000400UL)->ENVP_CFG . bit).envp_afc, 1);

   
    
      (((DSP_Type *) 0x50000400UL)->ENVP_CFG . bit).dsr_sel          = loc_pParam->fields.SpxDs;
      loc_readBackAfterWrite((((DSP_Type *) 0x50000400UL)->ENVP_CFG . bit).dsr_sel, loc_pParam->fields.SpxDs);    
      /* configure dsp -> fast time constant module */
      (((DSP_Type *) 0x50000400UL)->FTC_CTRL . bit).ftc_en           = loc_pParam->fields.SpxFtcEn;
      loc_readBackAfterWrite((((DSP_Type *) 0x50000400UL)->FTC_CTRL . bit).ftc_en, loc_pParam->fields.SpxFtcEn);
      (((DSP_Type *) 0x50000400UL)->FTC_CTRL . bit).ftc_cfg          = loc_pParam->fields.SpxFtcCfg;
      loc_readBackAfterWrite((((DSP_Type *) 0x50000400UL)->FTC_CTRL . bit).ftc_cfg, loc_pParam->fields.SpxFtcCfg);
    
       /* configure dsp -> sensitivity time control */
      (((DSP_Type *) 0x50000400UL)->STC_CTRL . bit).ampd_stc_mod     = loc_pParam->fields.SpxStcMod;
      loc_readBackAfterWrite((((DSP_Type *) 0x50000400UL)->STC_CTRL . bit).ampd_stc_mod, loc_pParam->fields.SpxStcMod);
      (((DSP_Type *) 0x50000400UL)->STC_CTRL . bit).ampd_g_dig_target= loc_pParam->fields.SpxMeasGain;
      loc_readBackAfterWrite((((DSP_Type *) 0x50000400UL)->STC_CTRL . bit).ampd_g_dig_target, loc_pParam->fields.SpxMeasGain);
      (((DSP_Type *) 0x50000400UL)->STC_TB . bit).ampd_stc_tb        = loc_pParam->fields.SpxStcTb;
      loc_readBackAfterWrite((((DSP_Type *) 0x50000400UL)->STC_TB . bit).ampd_stc_tb, loc_pParam->fields.SpxStcTb);
      
      /* configure dsp -> automatic threshold generator */
      (((DSP_Type *) 0x50000400UL)->ATG_CTRL . bit).atg_cfg          = loc_pParam->fields.SpxAtgCfg;
      loc_readBackAfterWrite((((DSP_Type *) 0x50000400UL)->ATG_CTRL . bit).atg_cfg, loc_pParam->fields.SpxAtgCfg);
      (((DSP_Type *) 0x50000400UL)->ATG_CTRL . bit).atg_ini          = loc_pParam->fields.SpxAtgIni;
      loc_readBackAfterWrite((((DSP_Type *) 0x50000400UL)->ATG_CTRL . bit).atg_ini, loc_pParam->fields.SpxAtgIni);
      (((DSP_Type *) 0x50000400UL)->ATG_CTRL . bit).atg_alpha        = loc_pParam->fields.SpxAtgAlpha;
      loc_readBackAfterWrite((((DSP_Type *) 0x50000400UL)->ATG_CTRL . bit).atg_alpha, loc_pParam->fields.SpxAtgAlpha);
      (((DSP_Type *) 0x50000400UL)->ATG_CTRL . bit).atg_tau          = loc_pParam->fields.SpxAtgTau;
      loc_readBackAfterWrite((((DSP_Type *) 0x50000400UL)->ATG_CTRL . bit).atg_tau, loc_pParam->fields.SpxAtgTau);
      
      /* configure dsp -> echo evaluation SpxEevalSens */
      ((((DSP_Type *) 0x50000400UL)->EEVAL_CTRL . bit). eeval_sens = (uint8_t)(loc_pParam->fields . SpxEevalSens));
      loc_readBackAfterWrite(((uint8_t)(((DSP_Type *) 0x50000400UL)->EEVAL_CTRL . bit). eeval_sens), loc_pParam->fields.SpxEevalSens);

    (((DSP_Type *) 0x50000400UL)->EEVAL_CTRL . bit).eeval_dma_val  = loc_pParam->fields.SpxEevalVal;
    loc_readBackAfterWrite((((DSP_Type *) 0x50000400UL)->EEVAL_CTRL . bit).eeval_dma_val, loc_pParam->fields.SpxEevalVal);
    ((((DSP_Type *) 0x50000400UL)->EEVAL_CTRL . bit). eeval_sel = (loc_pParam->fields . SpxEevalSel));
    loc_readBackAfterWrite(((((DSP_Type *) 0x50000400UL)->EEVAL_CTRL . bit). eeval_sel), loc_pParam->fields.SpxEevalSel);
  }
  else
  {
    /* nothing to do here */
...
void loc_TaskState_INIT_Adv(void)
{
  bool_t execute = 1;/*-?|AP5|wladimir.pauls|c3|?*/
  ...
  if(1 == execute)
  {
     ...
     */
    /* configure burst generator */
    (((BRG_Type *) 0x50000300UL)->BRG_CFG . bit).burst_type          = 1;
    loc_readBackAfterWrite((((BRG_Type *) 0x50000300UL)->BRG_CFG . bit).burst_type, 1);
    ...
    {
      /* compensate of f0 */
      f_0 = loc_pParam->fields.ApxBurstFreqLo * (768u) / Dsi3DrvImp_HWModIfFuns->Get1usClockCfg();
      f_1 = loc_pParam->fields.ApxBurstFreqHi * (768u) / Dsi3DrvImp_HWModIfFuns->Get1usClockCfg();
    }
    else
    {
      /* just use standard values */
    ...
    (((BRG_Type *) 0x50000300UL)->BRG_F0 . bit).f_0              = f_0;
    loc_readBackAfterWrite((((BRG_Type *) 0x50000300UL)->BRG_F0 . bit).f_0, f_0);
    (((BRG_Type *) 0x50000300UL)->BRG_F1 . bit).f_1              = f_1;
    loc_readBackAfterWrite((((BRG_Type *) 0x50000300UL)->BRG_F1 . bit).f_1, f_1);
    
    /* configure dsp -> envelope processor */
    (((DSP_Type *) 0x50000400UL)->ENVP_CFG . bit).aspi_sel           = 0;
    loc_readBackAfterWrite((((DSP_Type *) 0x50000400UL)->ENVP_CFG . bit).aspi_sel, 0);
    (((DSP_Type *) 0x50000400UL)->ENVP_FILT_CFG . bit).f1_coeff_sel  = 0;
    loc_readBackAfterWrite((((DSP_Type *) 0x50000400UL)->ENVP_FILT_CFG . bit).f1_coeff_sel, 0);
    (((DSP_Type *) 0x50000400UL)->ENVP_FILT_CFG . bit).f2_coeff_sel  = 0;
    loc_readBackAfterWrite((((DSP_Type *) 0x50000400UL)->ENVP_FILT_CFG . bit).f2_coeff_sel, 0);

      
      /* configure burst generator part 2 */
      (((BRG_Type *) 0x50000300UL)->BRG_CFG . bit).n_pulses            = loc_pParam->fields.ApxBurstPulses;
      loc_readBackAfterWrite((((BRG_Type *) 0x50000300UL)->BRG_CFG . bit).n_pulses, loc_pParam->fields.ApxBurstPulses);
      (((BRG_Type *) 0x50000300UL)->BRG_CFG . bit).code_len            = loc_pParam->fields.ApxCodeLength;
      loc_readBackAfterWrite((((BRG_Type *) 0x50000300UL)->BRG_CFG . bit).code_len, loc_pParam->fields.ApxCodeLength);
      (((BRG_Type *) 0x50000300UL)->BRG_FDELTA . bit).f_delta          = loc_pParam->fields.ApxBurstFreqDelta;
      loc_readBackAfterWrite((((BRG_Type *) 0x50000300UL)->BRG_FDELTA . bit).f_delta, loc_pParam->fields.ApxBurstFreqDelta);
       
      /* configure dsp -> downsampling and filter length */
      (((DSP_Type *) 0x50000400UL)->ENVP_CFG . bit).dsr_sel            = loc_pParam->fields.ApxDs;
      loc_readBackAfterWrite((((DSP_Type *) 0x50000400UL)->ENVP_CFG . bit).dsr_sel, loc_pParam->fields.ApxDs);
      (((DSP_Type *) 0x50000400UL)->ENVP_FILT_CFG . bit).filt_len_code = loc_pParam->fields.ApxFilterLength;
      loc_readBackAfterWrite((((DSP_Type *) 0x50000400UL)->ENVP_FILT_CFG . bit).filt_len_code, loc_pParam->fields.ApxFilterLength);
      
      /* configure dsp -> filter coefficients */
      (((DSP_Type *) 0x50000400UL)->ENVP_COEFF_3_2_1_0 . bit).coeff    = loc_pParam->fields.ApxEnvpCoeff3_0;
      loc_readBackAfterWrite((((DSP_Type *) 0x50000400UL)->ENVP_COEFF_3_2_1_0 . bit).coeff, loc_pParam->fields.ApxEnvpCoeff3_0);
      (((DSP_Type *) 0x50000400UL)->ENVP_COEFF_7_6_5_4 . bit).coeff    = loc_pParam->fields.ApxEnvpCoeff7_4;
      loc_readBackAfterWrite((((DSP_Type *) 0x50000400UL)->ENVP_COEFF_7_6_5_4 . bit).coeff, loc_pParam->fields.ApxEnvpCoeff7_4);
      (((DSP_Type *) 0x50000400UL)->ENVP_COEFF_11_10_9_8 . bit).coeff  = loc_pParam->fields.ApxEnvpCoeff11_8;
      loc_readBackAfterWrite((((DSP_Type *) 0x50000400UL)->ENVP_COEFF_11_10_9_8 . bit).coeff, loc_pParam->fields.ApxEnvpCoeff11_8);
      (((DSP_Type *) 0x50000400UL)->ENVP_COEFF_15_14_13_12 . bit).coeff= loc_pParam->fields.ApxEnvpCoeff15_12;
      loc_readBackAfterWrite((((DSP_Type *) 0x50000400UL)->ENVP_COEFF_15_14_13_12 . bit).coeff, loc_pParam->fields.ApxEnvpCoeff15_12);
      (((DSP_Type *) 0x50000400UL)->ENVP_COEFF_19_18_17_16 . bit).coeff= loc_pParam->fields.ApxEnvpCoeff19_16;
      loc_readBackAfterWrite((((DSP_Type *) 0x50000400UL)->ENVP_COEFF_19_18_17_16 . bit).coeff, loc_pParam->fields.ApxEnvpCoeff19_16);
      (((DSP_Type *) 0x50000400UL)->ENVP_COEFF_23_22_21_20 . bit).coeff= loc_pParam->fields.ApxEnvpCoeff23_20;
      loc_readBackAfterWrite((((DSP_Type *) 0x50000400UL)->ENVP_COEFF_23_22_21_20 . bit).coeff, loc_pParam->fields.ApxEnvpCoeff23_20);
      (((DSP_Type *) 0x50000400UL)->ENVP_COEFF_27_26_25_24 . bit).coeff= loc_pParam->fields.ApxEnvpCoeff27_24;
      loc_readBackAfterWrite((((DSP_Type *) 0x50000400UL)->ENVP_COEFF_27_26_25_24 . bit).coeff, loc_pParam->fields.ApxEnvpCoeff27_24);
      (((DSP_Type *) 0x50000400UL)->ENVP_COEFF_31_30_29_28 . bit).coeff= loc_pParam->fields.ApxEnvpCoeff31_28;
      loc_readBackAfterWrite((((DSP_Type *) 0x50000400UL)->ENVP_COEFF_31_30_29_28 . bit).coeff, loc_pParam->fields.ApxEnvpCoeff31_28);  
      
      /* configure dsp -> advanced automatic threshold generator */
      (((DSP_Type *) 0x50000400UL)->AATG1_CTRL . bit).aatg1_off        = loc_pParam->fields.ApxAatgOff;
      loc_readBackAfterWrite((((DSP_Type *) 0x50000400UL)->AATG1_CTRL . bit).aatg1_off, loc_pParam->fields.ApxAatgOff);
      (((DSP_Type *) 0x50000400UL)->AATG1_CTRL . bit).aatg1_alpha      = loc_pParam->fields.ApxAatgAlpha;
      loc_readBackAfterWrite((((DSP_Type *) 0x50000400UL)->AATG1_CTRL . bit).aatg1_alpha, loc_pParam->fields.ApxAatgAlpha);
      (((DSP_Type *) 0x50000400UL)->AATG1_CTRL . bit).aatg1_cw         = loc_pParam->fields.ApxAatgCw;
      loc_readBackAfterWrite((((DSP_Type *) 0x50000400UL)->AATG1_CTRL . bit).aatg1_cw, loc_pParam->fields.ApxAatgCw);
      (((DSP_Type *) 0x50000400UL)->AATG1_CTRL . bit).aatg1_cn         = loc_pParam->fields.ApxAatgCn;
      loc_readBackAfterWrite((((DSP_Type *) 0x50000400UL)->AATG1_CTRL . bit).aatg1_cn, loc_pParam->fields.ApxAatgCn);
      (((DSP_Type *) 0x50000400UL)->AATG2_CTRL . bit).aatg2_off        = loc_pParam->fields.ApxAatgOff;
      loc_readBackAfterWrite((((DSP_Type *) 0x50000400UL)->AATG2_CTRL . bit).aatg2_off, loc_pParam->fields.ApxAatgOff);
      (((DSP_Type *) 0x50000400UL)->AATG2_CTRL . bit).aatg2_alpha      = loc_pParam->fields.ApxAatgAlpha;
      loc_readBackAfterWrite((((DSP_Type *) 0x50000400UL)->AATG2_CTRL . bit).aatg2_alpha, loc_pParam->fields.ApxAatgAlpha);
      (((DSP_Type *) 0x50000400UL)->AATG2_CTRL . bit).aatg2_cw         = loc_pParam->fields.ApxAatgCw;
      loc_readBackAfterWrite((((DSP_Type *) 0x50000400UL)->AATG2_CTRL . bit).aatg2_cw, loc_pParam->fields.ApxAatgCw);
      (((DSP_Type *) 0x50000400UL)->AATG2_CTRL . bit).aatg2_cn         = loc_pParam->fields.ApxAatgCn;
      loc_readBackAfterWrite((((DSP_Type *) 0x50000400UL)->AATG2_CTRL . bit).aatg2_cn, loc_pParam->fields.ApxAatgCn);
      
      /* configure dsp -> echo evaluation */
      (((DSP_Type *) 0x50000400UL)->EEVAL_CTRL . bit).eeval_sens       = loc_pParam->fields.ApxEevalSens;
      loc_readBackAfterWrite((((DSP_Type *) 0x50000400UL)->EEVAL_CTRL . bit).eeval_sens, loc_pParam->fields.ApxEevalSens);
...
void loc_TaskState_INIT_Noise(void)
{
  ...
  ((((DSP_Type *) 0x50000400UL)->STC_TB . bit). ampd_stc_tb = (0u));
  
  /* set registers for the noise measurement */
  (((DSP_Type *) 0x50000400UL)->ENVP_CFG . bit).envp_cfg     = loc_AppRtData.Parameters.data.NoiseMeasurement.fields.NoiseMeasFilterBw;
  loc_readBackAfterWrite((((DSP_Type *) 0x50000400UL)->ENVP_CFG . bit).envp_cfg, loc_AppRtData.Parameters.data.NoiseMeasurement.fields.NoiseMeasFilterBw);
 
    (((DSP_Type *) 0x50000400UL)->AMPD_CTRL . bit).ampd_g_dig  = loc_AppRtData.Parameters.data.NoiseMeasurement.fields.NoiseMeasGain;
    loc_readBackAfterWrite((((DSP_Type *) 0x50000400UL)->AMPD_CTRL . bit).ampd_g_dig, loc_AppRtData.Parameters.data.NoiseMeasurement.fields.NoiseMeasGain); 
  /* Switch DSP on */
  ((((DSP_Type *) 0x50000400UL)->DSP_CTRL . bit). dsp_on = (1u));

  /* Burst length for start of noise measurement is zero to start receive-only mode */
  (((BRG_Type *) 0x50000300UL)->BRG_CFG . bit).n_pulses = 0;
  loc_readBackAfterWrite((((BRG_Type *) 0x50000300UL)->BRG_CFG . bit).n_pulses, 0);

  /* Set threshold to noise threshold without a change step */
  ((((DSP_Type *) 0x50000400UL)->STG_TH . bit). stg_th = (loc_AppRtData . Parameters . data . NoiseMeasurement . fields . NoiseMeasThreshold));
  ((((DSP_Type *) 0x50000400UL)->STG_STEP . bit). stg_step = (0u));
}
...
void loc_TaskState_INIT_ECHO_MEAS_Std(void)
{
  bool_t execute = 1;/*-?|AP5|wladimir.pauls|c4|?*/
  ...
  if(1 == execute)
  {
    ...
    (((BRG_Type *) 0x50000300UL)->BRG_CFG . bit).n_pulses      = loc_pParam->fields.SpxBurstPulses;
    loc_readBackAfterWrite((((BRG_Type *) 0x50000300UL)->BRG_CFG . bit).n_pulses, loc_pParam->fields.SpxBurstPulses);
    (((DSP_Type *) 0x50000400UL)->ENVP_CFG . bit).envp_cfg     = loc_pParam->fields.SpxMeasFilterBw;
    loc_readBackAfterWrite((((DSP_Type *) 0x50000400UL)->ENVP_CFG . bit).envp_cfg, loc_pParam->fields.SpxMeasFilterBw);

      (((DSP_Type *) 0x50000400UL)->AMPD_CTRL . bit).ampd_g_dig  = loc_pParam->fields.SpxMeasGain;
      loc_readBackAfterWrite((((DSP_Type *) 0x50000400UL)->AMPD_CTRL . bit).ampd_g_dig, loc_pParam->fields.SpxMeasGain);
    
    /* set initial static threshold values */
    ((((DSP_Type *) 0x50000400UL)->STG_TH . bit). stg_th = (loc_pParam->fields . SpxStgHeight1));
    ((((DSP_Type *) 0x50000400UL)->STG_STEP . bit). stg_step = (0u));
    ...
    if((0u) == loc_pParam->fields.SpxMeasFilterBw)
    {
      if((8u) > loc_pParam->fields.SpxBurstPulses)
      {
        (((DSP_Type *) 0x50000400UL)->ENVP_CFG . bit).envp_cfg = (0x4u);
        loc_readBackAfterWrite((((DSP_Type *) 0x50000400UL)->ENVP_CFG . bit).envp_cfg, (0x4u));
      }
      else
      {
        if((28u) > loc_pParam->fields.SpxBurstPulses)
        {
          (((DSP_Type *) 0x50000400UL)->ENVP_CFG . bit).envp_cfg = (0x5u);
          loc_readBackAfterWrite((((DSP_Type *) 0x50000400UL)->ENVP_CFG . bit).envp_cfg, (0x5u));
        }
        else
        {
          (((DSP_Type *) 0x50000400UL)->ENVP_CFG . bit).envp_cfg = (0x6u);
          loc_readBackAfterWrite((((DSP_Type *) 0x50000400UL)->ENVP_CFG . bit).envp_cfg, (0x6u));
        }
      }
    }
    else
...
void loc_TaskState_PreCalcParam_INIT_ECHO_MEAS_Std(Meas_uStandardPathProfile* loc_pParam)
{
  ...
  /* calc stg parameters for interval 2 */
   if(loc_pParam->fields.SpxStgHeight2 > loc_pParam->fields.SpxStgHeight1)
   {
     ...
     preCalculatedStgParam.Gradient1 = (1u);
     /* in case of timing problems: could be precalculated in initialization */
     preCalculatedStgParam.TimeBase1 = (uint16_t)((uint32_t)(loc_pParam->fields.SpxStgInterval2 * (32u)) / (uint16_t)(loc_pParam->fields.SpxStgHeight2 - loc_pParam->fields.SpxStgHeight1));
   }
   else
   {
     if(loc_pParam->fields.SpxStgHeight2 < loc_pParam->fields.SpxStgHeight1)
     {
       ...
       /* PRQA S 2895 1 */
       preCalculatedStgParam.Gradient1 = ((uint8_t)(-1));
       /* in case of timing problems: could be precalculated in initialization */
       preCalculatedStgParam.TimeBase1 = (uint16_t)((uint32_t)(loc_pParam->fields.SpxStgInterval2 * (32u)) / (uint16_t)(loc_pParam->fields.SpxStgHeight1 - loc_pParam->fields.SpxStgHeight2));
     }
     else
     {
   ...
   {
     /* STG curve has positive gradient in this period */
     preCalculatedStgParam.Gradient2 = (1u);
     /* in case of timing problems: could be precalculated in initialization */
     preCalculatedStgParam.TimeBase2 = (uint16_t)((uint32_t)(loc_pParam->fields.SpxStgInterval3 * (32u)) / (uint16_t)(loc_pParam->fields.SpxStgHeight3 - loc_pParam->fields.SpxStgHeight2)); 
   }
   else
   {
     if(loc_pParam->fields.SpxStgHeight3 < loc_pParam->fields.SpxStgHeight2)
     {
       ...
       /* rule suppression: this cast is because of signed register value of STG_STEP */
       /* PRQA S 2895 1 */
       preCalculatedStgParam.Gradient2 = ((uint8_t)(-1));
       /* in case of timing problems: could be precalculated in initialization */
       preCalculatedStgParam.TimeBase2 = (uint16_t)((uint32_t)(loc_pParam->fields.SpxStgInterval3 * (32u)) /(uint16_t)(loc_pParam->fields.SpxStgHeight2 - loc_pParam->fields.SpxStgHeight3));
     }
     else
     {
       /* no change in this interval */
   ...
   {
     /* STG curve has positive gradient in this period */
     preCalculatedStgParam.Gradient3 = (1u);
     /* in case of timing problems: could be precalculated in initialization */
     preCalculatedStgParam.TimeBase3 = (uint16_t)((uint32_t)(loc_pParam->fields.SpxStgInterval4 * (32u)) / (uint16_t)(loc_pParam->fields.SpxStgHeight4 - loc_pParam->fields.SpxStgHeight3));
   }
   else
   {
     if(loc_pParam->fields.SpxStgHeight4 < loc_pParam->fields.SpxStgHeight3)
     {
       ...
       /* rule suppression: this cast is because of signed register value of STG_STEP */
       /* PRQA S 2895 1 */
       preCalculatedStgParam.Gradient3 = ((uint8_t)(-1));
       /* in case of timing problems: could be precalculated in initialization */
       preCalculatedStgParam.TimeBase3 = (uint16_t)((uint32_t)(loc_pParam->fields.SpxStgInterval4 * (32u)) / (uint16_t)(loc_pParam->fields.SpxStgHeight3 - loc_pParam->fields.SpxStgHeight4));
     }
     else
     {
       /* no change in this interval */
...
void loc_TaskState_INIT_ECHO_MEAS_Adv(void)
{
  bool_t execute = 1;/*-?|AP5|wladimir.pauls|c5|?*/
  ...
  if(1 == execute)
  {
    ...
    case meas_eMeasConf_DIRECT:     /* chirp up */
      (((BRG_Type *) 0x50000300UL)->BRG_CODE . bit).code               = loc_pParam->fields.ApxCode;
      loc_readBackAfterWrite((((BRG_Type *) 0x50000300UL)->BRG_CODE . bit).code, loc_pParam->fields.ApxCode);
      /* set masking time */
    ...
    case meas_eMeasConf_DIRECT_INV: /* chirp up inverted */
      (((BRG_Type *) 0x50000300UL)->BRG_CODE . bit).code               = ~(uint32_t)loc_pParam->fields.ApxCode;
      loc_readBackAfterWrite((((BRG_Type *) 0x50000300UL)->BRG_CODE . bit).code, ~(uint32_t)loc_pParam->fields.ApxCode);
      /* set masking time */
      loc_AppRtData.RuntimeData.MaskingTime = (loc_pParam->fields.ApxMeasMaskDirect) + (loc_AppRtData.RuntimeData.TOF_Compensation>>5); 
      break;
...
void loc_TaskState_INIT_ECHO_MEAS_Nfd(void)
{
  ...
  ((((DSP_Type *) 0x50000400UL)->NFD_CTRL . bit). nfd_irq_cfg = (dsp_NFDIRQ_Echos_t)(loc_AppRtData . Parameters . data . NfdSettings . fields . NfdCtrlIrq));
  loc_readBackAfterWrite(((dsp_NFDIRQ_Echos_t)(((DSP_Type *) 0x50000400UL)->NFD_CTRL . bit). nfd_irq_cfg), loc_AppRtData.Parameters.data.NfdSettings.fields.NfdCtrlIrq);
  ((((DSP_Type *) 0x50000400UL)->NFD_CTRL . bit). nfd_sens = (loc_AppRtData . Parameters . data . NfdSettings . fields . NfdCtrlSens));
  loc_readBackAfterWrite(((((DSP_Type *) 0x50000400UL)->NFD_CTRL . bit). nfd_sens), loc_AppRtData.Parameters.data.NfdSettings.fields.NfdCtrlSens);
  (((DSP_Type *) 0x50000400UL)->NFD_TH . bit).nfd_th = loc_AppRtData.Parameters.data.NfdSettings.fields.NfdThreshold;
  loc_readBackAfterWrite((((DSP_Type *) 0x50000400UL)->NFD_TH . bit).nfd_th, loc_AppRtData.Parameters.data.NfdSettings.fields.NfdThreshold);
}
...
void loc_TaskState_ECHO_MEAS_async(void)
{
  ...
  if( ((0xFFFFu) <= (((DSP_Type *) 0x50000400UL)->MT . bit).mt_ts) || (loc_AppRtData.RuntimeData.Meas_time <= (((DSP_Type *) 0x50000400UL)->MT . bit).mt_ts) )
  {
  ...
  else
  {
    ...
    if(meas_eMeasConf_INDIRECT != loc_AppRtData.RuntimeData.MeasurementConf)
    {
      ...
      if((1u) == (((BRG_Type *) 0x50000300UL)->BRG_CTRL . bit).burst_sta)
      {
        /* driver voltage monitoring - VTANK over voltage (async) */
        if( ((((BRG_Type *) 0x50000300UL)->TDR_STATUS . reg) & (8u)) != 0u )
        {
      ...
      else
      {
        ...
        loc_AppRtData.Results.BurstMonitoring.AccquisitionFinished = 1;
      }
      /* Burst status (sync) */
...
void loc_TaskState_ECHO_MEAS_manage_stc_and_stg(void)
{
  ...
  if(preCalculatedStcParam.StcStart == loc_AppRtData.Results.MeasurementTime)
  {
    ...
    (((DSP_Type *) 0x50000400UL)->STC_CTRL . bit).ampd_stc_mod     = preCalculatedStcParam.StcMod;
    (((DSP_Type *) 0x50000400UL)->STC_CTRL . bit).ampd_g_dig_target= preCalculatedStcParam.StcGain;
    (((DSP_Type *) 0x50000400UL)->STC_TB . bit).ampd_stc_tb        = preCalculatedStcParam.StcTb;
  }
  ...
  {
   /* set curve gradient */
   ((((DSP_Type *) 0x50000400UL)->STG_STEP . bit). stg_step = (preCalculatedStgParam . Gradient1));
   ((((DSP_Type *) 0x50000400UL)->STG_TB . bit). stg_tb = (preCalculatedStgParam . TimeBase1));
  }
  else if(preCalculatedStgParam.Interval2 == loc_AppRtData.Results.MeasurementTime)
  {
   /* set curve gradient */
   ((((DSP_Type *) 0x50000400UL)->STG_STEP . bit). stg_step = (preCalculatedStgParam . Gradient2));
   ((((DSP_Type *) 0x50000400UL)->STG_TB . bit). stg_tb = (preCalculatedStgParam . TimeBase2));
  }
  else if(preCalculatedStgParam.Interval3 == loc_AppRtData.Results.MeasurementTime)
  {
   /* set curve gradient */
   ((((DSP_Type *) 0x50000400UL)->STG_STEP . bit). stg_step = (preCalculatedStgParam . Gradient3));
   ((((DSP_Type *) 0x50000400UL)->STG_TB . bit). stg_tb = (preCalculatedStgParam . TimeBase3));
  }
  else if(preCalculatedStgParam.Interval4 == loc_AppRtData.Results.MeasurementTime)
  {
   /* set curve gradient */
   ((((DSP_Type *) 0x50000400UL)->STG_STEP . bit). stg_step = (0u));
   ((((DSP_Type *) 0x50000400UL)->STG_TB . bit). stg_tb = (0u));
  }
}
  ...
  else
  {
    ...
    if(meas_eMeasConf_INDIRECT != loc_AppRtData.RuntimeData.MeasurementConf)
    {
      ...
      { /* no burst running -> do not increment burst length */
        ...
        (((BRG_Type *) 0x50000300UL)->BRG_CFG . bit).n_pulses = 0; /* see SM13 */
      }
    ...
    /* Noise measurement during echo detection (sync) */ 
    if((loc_AppRtData.Results.MeasurementTime & (32u-1u)) == (32u-1u))
    {
      ...
      uint32_t sample = (((DSP_Type *) 0x50000400UL)->ATG_TH . bit).atg_th >> 2;
...
void loc_TaskState_POST_MEAS(void)
{
  ...
  else if ( (0u) == loc_AppRtData.Parameters.data.Monitoring.halfwords[1] ) 
  {
  ...
  /* see SM14 */
  ((((BRG_Type *) 0x50000300UL)->BRG_CTRL . bit). burst_brk = (1u));
  /* disable all timers */
  ((((SWTIMER_Type *) 0x50000100UL)->IRQ_MASK . reg) &= ~(1u << (0x0FU & (uint16_t)(swtimer_IRQ_EVT_CNT_ZERO_1))));
  ((((SWTIMER_Type *) 0x50000100UL)->IRQ_VNO . reg) = (swtimer_eInterruptVectorNum_t)(swtimer_IRQ_EVT_CNT_ZERO_1));
  ((((SWTIMER_Type *) 0x50000100UL)->CONFIG . reg) &= ~(1u << (0x03U & (uint16_t)(swtimer_eTimer_1))));
...
void loc_check_TdrStat(void)
{
  ...
  if ( brg_eTDRStatus_Normal != ((brg_TDRStatus_t)(((BRG_Type *) 0x50000300UL)->TDR_STATUS . bit). drvs_sta) )
  {
    err_SetHwErrorFlag(ERR_NO_ERROR1, ERR_DRVS_FAILURE_DURING_BURST);
  }
  /* check drv1 status bit */
  if ( brg_eTDRStatus_Normal != ((brg_TDRStatus_t)(((BRG_Type *) 0x50000300UL)->TDR_STATUS . bit). drv1_sta) )
  {
    err_SetHwErrorFlag(ERR_NO_ERROR1, ERR_DRV1_FAILURE_DURING_BURST);
  }
  /* check drv2 status bit */
  if ( brg_eTDRStatus_Normal != ((brg_TDRStatus_t)(((BRG_Type *) 0x50000300UL)->TDR_STATUS . bit). drv2_sta)  )
  {
