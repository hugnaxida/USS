...
Dsi3HwModIf_cpInterfaceFunctions_t      Dsi3DrvImp_HWModIfFuns;                      /* points to a struct of the dsi3 hw interface functions */
  ...
  #pragma data_alignment=4
  uint8_t Dsi3_BusEnvData[( 340u)];                          /* Bus environment data container3 */
...
static const Dsi3BusIf_sCallbackFunctions_t Dsi3_BusCallbacks = {
    .CallbackVersion            = ((0x0104u)),                       /**< DSI3 callbacks version number */
    .Error                      = &Dsi3_BusErrorCbFun,                              /**< DRI3 bus error callback function */
    .ModeChanged                = &Dsi3_BusModeChangedCbFun,                        /**< DSI3 mode has changed callback function */
    .DiscProcessed              = &Dsi3_BusAutoAddrCbFun,                     /**< DSI3 auto addressing function */
    .CrmProcessed               = ((void *)0),                                                 /**< undefined by bus layer */
    .PdcmProcessed              = ((void *)0),                                                 /**< undefined by bus layer */
...
/* Retrieve IF pointer from DSI3 IF */
  ...
  if((pAppData->MeasCtrl->Parameters.data.SlaveId.fields.SlaveId > 0) &&
      pAppData->MeasCtrl->Parameters.data.SlaveId.fields.SlaveId <= (0x07u))
  {
  ...
  myStart = myStart - ((initialNad - 1) * (192u + 1u));
  ...
  const Dsi3BusImp_CfgData_t dsi3BusImpCfgData =
  {
    ...
    .CRMEnableSlaveIdPrefilter  = 1,
    
    .PDCMOutBufferSize          = (8u),
    ...
    .DISCDelayErrEvtHandling    = 1, 
     
    .DefaultCommunicationMode   = (Dsi3BusIf_eCOMM_COMMANDRESPONSEMODE)
  };
  ...
  if (retVal)
  {
    retVal = Dsi3_BusIfFuns->AppendCallbackTable((Dsi3BusIf_pGenericEnvData_t) Dsi3_BusEnvData, &Dsi3_BusCallbacks,((void*)(0UL)));
  }
  
  if (retVal)
  {
    /* Register DSI3 callback functions for register and memory manipulation */
    (void)Dsi3_BusIfFuns->RegisterCrmCb(Dsi3_BusEnvData, &Dsi3_CrmCmdHandler_Default                , dsi3Drv_eCRM_COMMAND_ID_NOP1                          , (Dsi3BusIf_pGenericCbCtxData_t)((void*)(0UL)));
    (void)Dsi3_BusIfFuns->RegisterCrmCb(Dsi3_BusEnvData, &Dsi3_CrmCmdHandler_MeasExecute            , dsi3Drv_eCRM_COMMAND_ID_MEASUREMENT_EXECUTE           , (Dsi3BusIf_pGenericCbCtxData_t)((void*)(0UL)));
    (void)Dsi3_BusIfFuns->RegisterCrmCb(Dsi3_BusEnvData, &Dsi3_CrmCmdHandler_AdvMeasurementExecute  , dsi3Drv_eCRM_COMMAND_ID_MEASUREMENT_ADVANCED_EXECUTE  , (Dsi3BusIf_pGenericCbCtxData_t)((void*)(0UL)));
    (void)Dsi3_BusIfFuns->RegisterCrmCb(Dsi3_BusEnvData, &Dsi3_CrmCmdHandler_Default                , dsi3Drv_eCRM_COMMAND_ID_NOP2                          , (Dsi3BusIf_pGenericCbCtxData_t)((void*)(0UL)));
    (void)Dsi3_BusIfFuns->RegisterCrmCb(Dsi3_BusEnvData, &Dsi3_CrmCmdHandler_MeasStop               , dsi3Drv_eCRM_COMMAND_ID_MEASUREMENT_STOP              , (Dsi3BusIf_pGenericCbCtxData_t)((void*)(0UL)));
    (void)Dsi3_BusIfFuns->RegisterCrmCb(Dsi3_BusEnvData, &Dsi3_CrmCmdHandler_Default                , dsi3Drv_eCRM_COMMAND_ID_NOP3                          , (Dsi3BusIf_pGenericCbCtxData_t)((void*)(0UL)));
    (void)Dsi3_BusIfFuns->RegisterCrmCb(Dsi3_BusEnvData, &Dsi3_CrmCmdHandler_Default                , dsi3Drv_eCRM_COMMAND_ID_NOP4                          , (Dsi3BusIf_pGenericCbCtxData_t)((void*)(0UL)));
    (void)Dsi3_BusIfFuns->RegisterCrmCb(Dsi3_BusEnvData, &Dsi3_CrmCmdHandler_Default                , dsi3Drv_eCRM_COMMAND_ID_NOP5                          , (Dsi3BusIf_pGenericCbCtxData_t)((void*)(0UL)));
    (void)Dsi3_BusIfFuns->RegisterCrmCb(Dsi3_BusEnvData, &Dsi3_CrmCmdHandler_MeasSettings           , dsi3Drv_eCRM_COMMAND_ID_MEASUREMENT_SETTINGS          , (Dsi3BusIf_pGenericCbCtxData_t)((void*)(0UL)));
    (void)Dsi3_BusIfFuns->RegisterCrmCb(Dsi3_BusEnvData, &Dsi3_CrmCmdHandler_MeasSettingsExt        , dsi3Drv_eCRM_COMMAND_ID_MEASUREMENT_SETTINGS_EXTENDED , (Dsi3BusIf_pGenericCbCtxData_t)((void*)(0UL)));
    (void)Dsi3_BusIfFuns->RegisterCrmCb(Dsi3_BusEnvData, &Dsi3_CrmCmdHandler_EEPROMAccess           , dsi3Drv_eCRM_COMMAND_ID_EEPROM_ACCESS                 , (Dsi3BusIf_pGenericCbCtxData_t)((void*)(0UL)));
    (void)Dsi3_BusIfFuns->RegisterCrmCb(Dsi3_BusEnvData, &Dsi3_CrmCmdHandler_RegisterAccess         , dsi3Drv_eCRM_COMMAND_ID_REGISTER_ACCESS               , (Dsi3BusIf_pGenericCbCtxData_t)((void*)(0UL)));
    (void)Dsi3_BusIfFuns->RegisterCrmCb(Dsi3_BusEnvData, &Dsi3_CrmCmdHandler_RegisterAccessExt      , dsi3Drv_eCRM_COMMAND_ID_REGISTER_ACCESS_EXTENDED      , (Dsi3BusIf_pGenericCbCtxData_t)((void*)(0UL)));
    (void)Dsi3_BusIfFuns->RegisterCrmCb(Dsi3_BusEnvData, &Dsi3_CrmCmdHandler_ReadStatInCRM        , dsi3Drv_eCRM_COMMAND_ID_READ_STATUS_IN_CRM            , (Dsi3BusIf_pGenericCbCtxData_t)((void*)(0UL)));
    (void)Dsi3_BusIfFuns->RegisterCrmCb(Dsi3_BusEnvData, &Dsi3_CrmCmdHandler_ReadStatInPDCM       , dsi3Drv_eCRM_COMMAND_ID_READ_STATUS_IN_PDCM           , (Dsi3BusIf_pGenericCbCtxData_t)((void*)(0UL)));
    (void)Dsi3_BusIfFuns->RegisterCrmCb(Dsi3_BusEnvData, &Dsi3_CrmCmdHandler_IcMode                 , dsi3Drv_eCRM_COMMAND_ID_IC_MODE                       , (Dsi3BusIf_pGenericCbCtxData_t)((void*)(0UL)));

    (void)Dsi3_BusIfFuns->RegisterPdcmCb(Dsi3_BusEnvData,&Dsi3_PdcmCmdHandler                      , (Dsi3BusIf_pGenericCbCtxData_t)((void*)(0UL)));
  }
