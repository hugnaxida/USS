...
void wdg_Init(void)
{
    ((((WDOG_Type *) 0x40000000UL)->RELOAD . bit). val = (uint16_t)((uint16_t)(20000uL)));
    ((((WDOG_Type *) 0x40000000UL)->PRESCALER . bit). val = (uint8_t)((uint8_t)(23u)));
    
    /* No watchdog window set for this demo
    WDOG_WINDOW_SIZE_SET(WDG_WINDOW_SIZE)
    WDOG_WINDOW_ENABLE()  */
    
    (((SYS_STATE_Type *) 0x40000100UL)->RESET_ENABLE . reg) |= (0x0080u);     /*< Set watchdog counted to zero reset enable flag*/
...
void wdg_Trigger(void)
{
  ...
  ((((WDOG_Type *) 0x40000000UL)->CONTROL . reg) = (0xA500u) | (0x0002u));
}
...
{
  /* Enable the watchdog */
  ((((WDOG_Type *) 0x40000000UL)->CONTROL . reg) = (0xA500u) | (0x0001u));
