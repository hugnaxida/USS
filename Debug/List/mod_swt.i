...
{
  /* Initialize SWT IRQ */  
  swtimer_InterruptInitialisation(&nvic_InterfaceFunctions,&swtimer_envData, ((void *)0));
  
  nvic_InterfaceFunctions.SetModulePriority(nvic_CEVT_EXT_IRQ_3, nvic_Priority_Level_2);
   

  /* Set timer0 reload and divider */
  (*(&(((SWTIMER_Type *) 0x50000100UL)->CNT0_RELOAD . reg) + (swtimer_eTimer_0)) = (uint16_t)(31));
  (*(&(((SWTIMER_Type *) 0x50000100UL)->DIV0_RELOAD . reg) + (swtimer_eTimer_0)) = (uint16_t)(23));
  ((((SWTIMER_Type *) 0x50000100UL)->CONFIG . reg) |= (1u << (0x03U & (uint16_t)(swtimer_eTimer_0))));
  
  /* set timer1 divider */
  (*(&(((SWTIMER_Type *) 0x50000100UL)->DIV0_RELOAD . reg) + (swtimer_eTimer_1)) = (uint16_t)(23));
