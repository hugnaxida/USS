 ...
 *
 * @brief Module interrupt handler for SYS_STATE hardware module.
 *
 * Purpose:
 * This module provides functions for handling SYS_STATE interrupts
 * - Interrupt initialization
 * - Interrupt enabling
 * - Interrupt disabling
 * - Registering user callback function for interrupt handling
 ...
 ******************************************************************************/
typedef enum {
  sys_state_IRQ_CPU_LOCKUP              = 0u,
  sys_state_IRQ_DEBUG_RESET             = 1u,
  sys_state_IRQ_SOFTWARE                = 2u,
  sys_state_IRQ_SRAM_PARITY             = 3u,
  sys_state_IRQ_OTP_ECC_FAIL            = 4u,
  sys_state_IRQ_WATCHDOG_WINDOW         = 5u,
  sys_state_IRQ_WATCHDOG                = 6u,
  sys_state_IRQ_WATCHDOG_ZERO           = 7u,
  sys_state_IRQ_CRC16_MISMATCH          = 8u,
  sys_state_IRQ_TRIM_PARITY             = 9u,
    
  sys_state_INTERRUPT_VECTOR_CNT        = 10u  /**< Number of available interrupt vectors */
 ...
 *
 ******************************************************************************/
void sys_state_InterruptRegisterCallback(sys_state_eInterruptVectorNum_t irqsrc, sys_state_InterruptCallback_t cbfnc);
 ...
 *             have to presented and initialized.
 *
 * @post       SYS_STATE irqs can be used.
 *
 * @detaildesc
 * Initialize SYS_STATE IRQ handling.
 *
 ******************************************************************************/
void sys_state_InterruptInitialisation(nvic_cpInterfaceFunctions_t vicIf, sys_state_pInterruptEnvironmentData_t environmentdata, sys_state_pInterruptContextData_t contextdata);
...
/* *************************** DEFINES AND MACROS *****************************/
/* ****************************************************************************/
static const uint32_t loc_IcRegAccRegMapping[((22u) + 1)] = {
...
void Dsi3_Callbacks_Init(Dsi3Drv_pApplCtrlData_t applRuntimeData)//初始化DSI驱动回调的函数
{
  ...
  else
  {
    ...
    err_ErrorHandlerExt(210, ERR_MODLIST_DSI3);;
  }
}
...
void COMCtrl_Task(Dsi3BusIf_pGenericEnvData_t genericEnvData)//COMCtrl_Task 函数主要作用是作为一个循环执行的任务，监控并处理DSI3的通信同步需求，只有在正确初始化后才会正常执行相应操作。若在未初始化的情况下被调用，则会触发错误处理机制。
{
  ...
  {
    if(1 == loc_pApplRuntimeData->DSI3Ctrl->SyncFlag)
    {
      loc_pApplRuntimeData->DSI3Ctrl->SyncFlag = 0;
  ...
  else
  {
    ...
    err_ErrorHandlerExt(241, ERR_MODLIST_DSI3);;
  }
}
/*
    ...
    Dsi3BusIf_DiscoveryModeStatus_t currentDiscoveryModeStatus, Dsi3BusIf_pGenericCbCtxData_t genericTransCbCtxData)
{
  if (Dsi3BusIf_eDISCSTAT_ADDRESSED == currentDiscoveryModeStatus)
  {
    ...
    if (Dsi3_BusIfFuns->UpdateDeviceAddress(busEnvData, pulseNum))
    {
      ...
      myStart = myStart - ((pulseNum - 1) * (192u + 1u));
                                                           ...
                                                           Dsi3BusIf_pGenericCbCtxData_t genericCbCtxData)
{
  ...
  if(((void *)0) != loc_pApplRuntimeData)
  {
    loc_pApplRuntimeData->DSI3Ctrl->CrmCxtCommandLastSuccessfull = 0;

    /* disable EEPROM access */
    Eeprom_Disable();

    /* refresh CRM application data */
    loc_pApplRuntimeData->DSI3Ctrl->CrmCxtCommandLastSuccessfull = 1;
    (loc_pApplRuntimeData->DSI3Ctrl->CrmLastCommand = dsi3Drv_eCRM_COMMAND_ID_NOP1);

    loc_pApplRuntimeData->DSI3Ctrl->SyncFlag = 1;
  }
  else
  {
    /* called before init was executed correctly -> goto error handler */
    err_ErrorHandlerExt(456, ERR_MODLIST_DSI3);;
  }
                                                                      ...
                                                                      Dsi3BusIf_pGenericCbCtxData_t genericCbCtxData)
{
  ...
  /* Check Data */
  if ((((void *)0) != genericEnvData) && (((void *)0) != commandBuffer) && (((void *)0) != loc_pApplRuntimeData))
  {
    loc_pApplRuntimeData->DSI3Ctrl->CrmCxtCommandLastSuccessfull = 0;
    ...
    if(0 == Eeprom_CheckIfBusy())
    {
      ...
      if (( 0u) == rcvData.MeasurementExecute.PhysicalAddress)
      {
        bool_t errorFlagActive = 0;
        ...
        else
        {
          ...
          loc_pApplRuntimeData->MeasCtrl->RuntimeData.MeasAbortFlag = 1;
        }
      }
      else
      {
    ...
    /* refresh CRM application data */
    loc_pApplRuntimeData->DSI3Ctrl->CrmCxtCommandLastSuccessfull = 1;
    (loc_pApplRuntimeData->DSI3Ctrl->CrmLastCommand = dsi3Drv_eCRM_COMMAND_ID_MEASUREMENT_EXECUTE);
  ...
  {
    /* called before init was executed correctly -> goto error handler */
    err_ErrorHandlerExt(598, ERR_MODLIST_DSI3);;
  }
                                                                         ...
                                                                         Dsi3BusIf_pGenericCbCtxData_t genericCbCtxData)//high
{
  ...
  if ((((void *)0) != genericEnvData) && (((void *)0) != commandBuffer) && (((void *)0) != loc_pApplRuntimeData))
  {
    ...
    if(0 == Eeprom_CheckIfBusy())
    {
      ...
      /* Only execute if Wildcard */
      if (( 0u) == rcvData.AdvMeasurementExecute.PhysicalAddress)
      {
        bool_t errorFlagActive = 0;
        /* check if safe state is active */
        errorFlagActive = err_GetGlobalHwErrFlag();
    ...
    /* refresh CRM application data */
    loc_pApplRuntimeData->DSI3Ctrl->CrmCxtCommandLastSuccessfull = 1;
    (loc_pApplRuntimeData->DSI3Ctrl->CrmLastCommand = dsi3Drv_eCRM_COMMAND_ID_MEASUREMENT_ADVANCED_EXECUTE);
  ...
  {
    /* called before init was executed correctly -> goto error handler */
    err_ErrorHandlerExt(742, ERR_MODLIST_DSI3);;
  }
                                                                   ...
                                                                   Dsi3BusIf_pGenericCbCtxData_t genericCbCtxData)
{
  ...
  if ((((void *)0) != genericEnvData) && (((void *)0) != commandBuffer) && (((void *)0) != loc_pApplRuntimeData))
  {
    ...
    if(0 == Eeprom_CheckIfBusy())
    {
      ...
      {
      case 1:
        if((0x3) == rcvData.MeasurementStop.Sensor1)
        {
        ...
        break;
      case 2:
        if((0x3) == rcvData.MeasurementStop.Sensor2)
        {
          meas_AbortMeasurement();
        }
        else
        ...
        break;
      case 3:
        if((0x3) == rcvData.MeasurementStop.Sensor3)
        {
          meas_AbortMeasurement();
        }
        else
        ...
        break;
      case 4:
        if((0x3) == rcvData.MeasurementStop.Sensor4)
        {
          meas_AbortMeasurement();
        }
        else
        ...
        break;
      case 5:
        if((0x3) == rcvData.MeasurementStop.Sensor5)
        {
          meas_AbortMeasurement();
        }
        else
        ...
        break;
      case 6:
        if((0x3) == rcvData.MeasurementStop.Sensor6)
        {
          meas_AbortMeasurement();
        }
        else
  ...
  {
    /* called before init was executed correctly -> goto error handler */
    err_ErrorHandlerExt(868, ERR_MODLIST_DSI3);;
  }
                                                                       ...
                                                                       Dsi3BusIf_pGenericCbCtxData_t genericCbCtxData)
{
  ...
  /* Check Data */
  if ((((void *)0) != genericEnvData) && (((void *)0) != commandBuffer) && (((void *)0) != responseBuffer) && (((void *)0) != loc_pApplRuntimeData))
  {
    loc_pApplRuntimeData->DSI3Ctrl->CrmCxtCommandLastSuccessfull = 0;
    ...
    if(0 == Eeprom_CheckIfBusy())
    {
      ...
      if((0u) == rcvData.MeasurementSettings.RW)
      {
        /* read operation */
        if(( 0u) == rcvData.MeasurementSettings.PhysicalAddress)
        {
          /* ignore on wildcard */
        }
        else
        {
          /* execute read */
          if(rcvData.MeasurementSettings.Address > (203u))
          {
    ...
    /* refresh CRM application data */
    (loc_pApplRuntimeData->DSI3Ctrl->CrmLastCommand = dsi3Drv_eCRM_COMMAND_ID_MEASUREMENT_SETTINGS);
  ...
  {
    /* called before init was executed correctly -> goto error handler */
    err_ErrorHandlerExt(1013, ERR_MODLIST_DSI3);;
  }
                                                                          ...
                                                                          Dsi3BusIf_pGenericCbCtxData_t genericCbCtxData)
{
  ...
  if ((((void *)0) != genericEnvData) && (((void *)0) != commandBuffer) && (((void *)0) != responseBuffer) && (((void *)0) != loc_pApplRuntimeData))
  {
    ...
    if(0 == Eeprom_CheckIfBusy())
    {
      ...
      if((dsi3Drv_eCRM_COMMAND_ID_MEASUREMENT_SETTINGS == loc_pApplRuntimeData->DSI3Ctrl->CrmLastCommand) && (1 == loc_pApplRuntimeData->DSI3Ctrl->CrmCxtCommandLastSuccessfull))
      {
    ...
    /* refresh CRM application data */
    (loc_pApplRuntimeData->DSI3Ctrl->CrmLastCommand = dsi3Drv_eCRM_COMMAND_ID_MEASUREMENT_SETTINGS_EXTENDED);
  ...
  {
    /* called before init was executed correctly -> goto error handler */
    err_ErrorHandlerExt(1119, ERR_MODLIST_DSI3);;
  }
                                                                ...
                                                                Dsi3BusIf_pGenericCbCtxData_t genericCbCtxData)
{
  ...
  if ((((void *)0) != genericEnvData) && (((void *)0) != commandBuffer) && (((void *)0) != responseBuffer) && (((void *)0) != loc_pApplRuntimeData))
  {
    ...
    /* refresh CRM application data */
    (loc_pApplRuntimeData->DSI3Ctrl->CrmLastCommand = dsi3Drv_eCRM_COMMAND_ID_EEPROM_ACCESS);
  ...
  {
    /* called before init was executed correctly -> goto error handler */
    err_ErrorHandlerExt(1216, ERR_MODLIST_DSI3);;
  }
                                                                  ...
                                                                  Dsi3BusIf_pGenericCbCtxData_t genericCbCtxData)
{
  ...
  if ((((void *)0) != genericEnvData) && (((void *)0) != commandBuffer) && (((void *)0) != responseBuffer) && (((void *)0) != loc_pApplRuntimeData))
  {
    ...
    if(0 == Eeprom_CheckIfBusy())
    {
      ...
      if((22u) >= rcvData.RegisterAccess.ModAddr)
      {
        /* is this a read or write operation? */
        if((0u) == rcvData.RegisterAccess.RW)
        {
          /* read command */
          if(( 0u) == rcvData.RegisterAccess.PhysicalAddress)
          {
            /* broadcast -> ignore */
          }
          else
    ...
    /* refresh CRM application data */
    (loc_pApplRuntimeData->DSI3Ctrl->CrmLastCommand = dsi3Drv_eCRM_COMMAND_ID_REGISTER_ACCESS);
  ...
  {
    /* called before init was executed correctly -> goto error handler */
    err_ErrorHandlerExt(1355, ERR_MODLIST_DSI3);;
  }
                                                                     ...
                                                                     Dsi3BusIf_pGenericCbCtxData_t genericCbCtxData)
{
  ...
  if ((((void *)0) != genericEnvData) && (((void *)0) != commandBuffer) && (((void *)0) != responseBuffer) && (((void *)0) != loc_pApplRuntimeData))
  {
    ...
    if((dsi3Drv_eCRM_COMMAND_ID_REGISTER_ACCESS == loc_pApplRuntimeData->DSI3Ctrl->CrmLastCommand) && (1 == loc_pApplRuntimeData->DSI3Ctrl->CrmCxtCommandLastSuccessfull))
    {
      /* only execute if no module is busy */
    if(0 == Eeprom_CheckIfBusy())
      {
    ...
    /* refresh CRM application data */
    (loc_pApplRuntimeData->DSI3Ctrl->CrmLastCommand = dsi3Drv_eCRM_COMMAND_ID_REGISTER_ACCESS_EXTENDED);
  ...
  {
    /* called before init was executed correctly -> goto error handler */
    err_ErrorHandlerExt(1464, ERR_MODLIST_DSI3);;
  }
                                                          ...
                                                          Dsi3BusIf_pGenericCbCtxData_t genericCbCtxData)
{
  ...
  if ((((void *)0) != genericEnvData) && (((void *)0) != commandBuffer) && (((void *)0) != responseBuffer) && (((void *)0) != loc_pApplRuntimeData))
  {
    ...
    if(( 0u) == rcvData.ReadStatusInCrm.PhysicalAddress)
    {
      /* broadcast -> ignore */
    }
    else
    ...
    if(0 == Eeprom_CheckIfBusy())
      {
        if(((void *)0) != ansData)
        {
          ...
          {
          case 0u:  /* PUDIN_H */
            ansData->Data1 = (( *( (uint16_t*)((0x48000000u) + 0xF6u) ) ) & 0xFF00u) >> 8u;
            ansData->Data2 =  ( *( (uint16_t*)((0x48000000u) + 0xF6u) ) ) & 0x00FFu;
            break;
          case 1u:  /* PUDIN_L */
            ansData->Data1 = (( *( (uint16_t*)((0x48000000u) + 0xF4u) ) ) & 0xFF00u) >> 8u;
            ansData->Data2 =  ( *( (uint16_t*)((0x48000000u) + 0xF4u) ) ) & 0x00FFu;
            break;
          ...
          case 20u: /* DIS_CLK_1US */
            ansData->Data1 = ((((DSI3_Type *) 0x50000200UL)->CLK_1US . reg) & 0xFF00u) >> 8u;
            ansData->Data2 =  (((DSI3_Type *) 0x50000200UL)->CLK_1US . reg) & 0x00FFu;
            break;
          case 21u: /* DSI_SYNC_CONT */
            ansData->Data1 = ((((DSI3_Type *) 0x50000200UL)->SYNC_CNT . reg) & 0xFF00u) >> 8u;
            ansData->Data2 =  (((DSI3_Type *) 0x50000200UL)->SYNC_CNT . reg) & 0x00FFu;
            break;
          case 22u: /* PDCM interval */
            ansData->Data1 = ((((DSI3_Type *) 0x50000200UL)->TIMER_COMPARE_B . reg) & 0xFF00u) >> 8u;
            ansData->Data2 =  (((DSI3_Type *) 0x50000200UL)->TIMER_COMPARE_B . reg) & 0x00FFu;
            break;
    ...
    /* refresh CRM application data */
    (loc_pApplRuntimeData->DSI3Ctrl->CrmLastCommand = dsi3Drv_eCRM_COMMAND_ID_READ_STATUS_IN_CRM);
  ...
  {
    /* called before init was executed correctly -> goto error handler */
    err_ErrorHandlerExt(1628, ERR_MODLIST_DSI3);;
  }
                                                                    ...
                                                                    Dsi3BusIf_pGenericCbCtxData_t genericCbCtxData)
{
  ...
  if ((((void *)0) != genericEnvData) && (((void *)0) != commandBuffer) && (((void *)0) != responseBuffer) && (((void *)0) != loc_pApplRuntimeData))
  {
    ...
    {
      /* is this a broadcast command? */
      if(( 0u) == rcvData.ReadStatusInPdcm.PhysicalAddress)
      {
    ...
    /* refresh CRM application data */
    (loc_pApplRuntimeData->DSI3Ctrl->CrmLastCommand = dsi3Drv_eCRM_COMMAND_ID_READ_STATUS_IN_PDCM);
  ...
  {
    /* called before init was executed correctly -> goto error handler */
    err_ErrorHandlerExt(1741, ERR_MODLIST_DSI3);;
  }
  return retVal;
}
/*
                                                          ...
                                                          Dsi3BusIf_pGenericCbCtxData_t genericCbCtxData)
{
  ...
  if ((((void *)0) != genericEnvData) && (((void *)0) != commandBuffer) && (((void *)0) != responseBuffer) && (((void *)0) != loc_pApplRuntimeData))
  {
    ...
    if(0 == Eeprom_CheckIfBusy())
    {
      if((0x55u) == rcvData.IcMode.Password)
      {
        ansData->Data1 = 0;
        ...
        case (0x04u):
          ...
          (((SYS_STATE_Type *) 0x40000100UL)->RESET_ENABLE . bit).software = 1;
          /* execute software reset */
          (((SYS_STATE_Type *) 0x40000100UL)->SW_RESET . bit).sw_reset = 1;
          break;
        case (0x08u):
          syss_EnterSleep();
          break;
        ...
        case (0x20u):
          /* switch DSP on */
          (((DSP_Type *) 0x50000400UL)->DSP_CTRL . bit).dsp_on = 1;
          break;
        case (0x40u):
          /* switch DSP off */
          (((DSP_Type *) 0x50000400UL)->DSP_CTRL . bit).dsp_on = 0;
          break;
        case (0x80u):
          /* reserved */
          break;
    ...
    /* refresh CRM application data */
    (loc_pApplRuntimeData->DSI3Ctrl->CrmLastCommand = dsi3Drv_eCRM_COMMAND_ID_IC_MODE);
  ...
  {
    /* called before init was executed correctly -> goto error handler */
    err_ErrorHandlerExt(1876, ERR_MODLIST_DSI3);;
  }
                                                  ...
                                                  Dsi3BusIf_pGenericCbCtxData_t genericCbCtxData)
{
   ...
   * ============================================================================================= */
  if((((void *)0) != responseBuffer) && (((void *)0) != loc_pApplRuntimeData) && (((void *)0) != msgLen))
  {
  ...
  {
    /* called before init was executed correctly -> goto error handler */
    err_ErrorHandlerExt(1953, ERR_MODLIST_DSI3);;
  }
...
static void loc_SynchCRMClock(Dsi3BusIf_pGenericEnvData_t genericEnvData)
{
     ...
     (DSI3_SYNC_ON_CRM_AND_PDCM == (dsi3_cfg_status_sync_t)loc_pApplRuntimeData->MeasCtrl->Parameters.data.DsiSettings.fields.SyncDsi3))
  {
    ...
    if ( (1u) == (((DSI3_Type *) 0x50000200UL)->CONFIG . bit . auto_sync))
    {
      (((DSI3_Type *) 0x50000200UL)->CONFIG . bit . auto_sync = (0u));
    }
    else
    {
      /* everything ok, go on */
    ...
    if(0u == (((DSI3_Type *) 0x50000200UL)->STATUS . bit).sync_cnt_err)
    {
      /* get DSI3 Sync_Count register value */
      syncVal = (((DSI3_Type *) 0x50000200UL)->SYNC_CNT . reg); 
      /* get DSI3 Clk 1us config */
      clkConfig = ((((DSI3_Type *) 0x50000200UL)->CLK_1US . reg));
      
      /* calculate deviation between DSI3 Clk 1us and Expected Chiptime */
      int32_t differenceExpectedVal = clkConfig-(0x0300);
      ...
      if (differenceSyncVal < (23))
      {
        /* check if deviation of clk config is smaller than 3% */
        if ( (syncVal > clkConfig) && (differenceExpectedVal < (23)) )
        {
  ...
  else
  {
    ...
    {
      (((DSI3_Type *) 0x50000200UL)->CONFIG . bit . auto_sync = (1u));
    }
    else
    {
      /* nothing to do here */
...
static void loc_SynchPDCMClock(Dsi3BusIf_pGenericEnvData_t genericEnvData)
{
  ...
  if(((void *)0) != loc_pApplRuntimeData)
  {
       ...
       (DSI3_SYNC_ON_CRM_AND_PDCM == (dsi3_cfg_status_sync_t)loc_pApplRuntimeData->MeasCtrl->Parameters.data.DsiSettings.fields.SyncDsi3))
    {
      ...
      compB = ((((DSI3_Type *) 0x50000200UL)->TIMER_COMPARE_B . reg));
      /* get DSI3 Clk 1us config */
      clkConfig = ((((DSI3_Type *) 0x50000200UL)->CLK_1US . reg));
...
static void loc_ChangeModeToPdcm(Dsi3BusIf_pGenericEnvData_t genericEnvData, Dsi3_ePDCMType_t pdcmType)
{
  if((((void *)0) != loc_pApplRuntimeData) && (((void *)0) != genericEnvData))
  {
  ...
  else
  {
    ...
    err_ErrorHandlerExt(2235, ERR_MODLIST_DSI3);;
  }
}
/*
