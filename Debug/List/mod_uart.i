...
void Uart_Init(void)
{
	uart_InterruptInitialisation(&nvic_InterfaceFunctions,&uart_envData, ((void *)0));

	nvic_InterfaceFunctions.SetModulePriority(nvic_CEVT_EXT_IRQ_6, nvic_Priority_Level_2);
	{(((UART_Type *) 0x5F000000UL)->BAUD_LOW . reg)=0XD0;};
	{ (((UART_Type *) 0x5F000000UL)->CTRL . reg) |=(0x0001u);};
	{ (((UART_Type *) 0x5F000000UL)->CTRL . reg) |=(0x0002u);};
	{ (((UART_Type *) 0x5F000000UL)->CTRL . reg) |=(0x0004u);};
	{ (((UART_Type *) 0x5F000000UL)->CTRL . reg) |=(0x0008u);}; 
	((((UART_Type *) 0x5F000000UL)->IRQ_MASK . reg) |= (1u << (0x0FU & (uint16_t)(uart_IRQ_RX))));
	((((UART_Type *) 0x5F000000UL)->IRQ_MASK . reg) |= (1u << (0x0FU & (uint16_t)(uart_IRQ_TX))));
...
void Uart_Send_data(uint8_t Send_data)
{
    (((UART_Type *) 0x5F000000UL)->DATA . reg) = Send_data; 
    while(!((((UART_Type *) 0x5F000000UL)->IRQ_STATUS . reg) & ((uart_eInterruptVectorNum_t)(1u << (uart_IRQ_TX)))));
    {(((UART_Type *) 0x5F000000UL)->INTCLR . reg) |= (0x0001u); }; 
}
/* *************************************************************************//**
 * @implementation
 *  Send  Data
...
void Uart_Receive_interrupt(uart_eInterruptVectorNum_t sno,  uart_pInterruptContextData_t contextdata)
{
  ...
  while (((((UART_Type *) 0x5F000000UL)->IRQ_STATUS . reg) & ((uart_eInterruptVectorNum_t)(1u << (uart_IRQ_RX)))) && last_uart_value<136u)
  {
     {(((UART_Type *) 0x5F000000UL)->INTCLR . reg) |= (0x0002u); };  
     rxData.uartRXbuffer[last_uart_value] = (((UART_Type *) 0x5F000000UL)->DATA . reg); 
     last_uart_value++;
  } 
