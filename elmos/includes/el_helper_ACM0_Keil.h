 ...
 *
 * $Id: el_helper_ACM0_Keil.h 383 2019-01-09 10:06:08Z siko $
 *
 * $Revision: 383 $
 *
 ******************************************************************************
...
#ifndef EL_HELPER_ACM0_KEIL_H_
#define EL_HELPER_ACM0_KEIL_H_

/* ****************************************************************************/
/* ******************************** INCLUDES **********************************/
/* ****************************************************************************/
#include "el_types.h"
 // TODO: remove this dependency (currently needed for __set_PRIMASK / __get_PRIMASK)    
 
#if defined(EL_DEVICE_M52417A)
  #include <io_m52417a.h> 
#elif defined(EL_DEVICE_M52417B)
  #include <io_m52417b.h> 
#elif defined(EL_DEVICE_M11720A)
  #include <io_m11720a.h> 
#elif defined(EL_DEVICE_M11720B)
  #include <io_m11720b.h> 
#elif defined(EL_DEVICE_M52342A)
  #include <io_m52342a.h> 
#else
 ...
 *
 ******************************************************************************/
extern bool_t el_CompareBytes(uint8_t * a, uint8_t * b, uint16_t size);

#endif /* EL_HELPER_ACM0_KEIL_H_ */
