...
#ifndef __EL_REGS_M52417B_H__
#define __EL_REGS_M52417B_H__
...
#define E_DSI3_ANALOG_CTRL_RCC_CURVE              (0x0040u)
#define E_DSI3_ANALOG_CTRL_FCC_HYST_SEL           (0x0400u)
#define E_DSI3_ANALOG_CTRL_FCC_FORCE_CONNECT      (0x0800u)
#define E_DSI3_ANALOG_CTRL_FCC_FORCE_BYPASS       (0x1000u)
...
#define DSI3_RCC_DAC                              (DSI3->RCC_DAC.reg)
#define DSI3_RCC_DAC_bit                          (DSI3->RCC_DAC.bit)

#define DSI3_HW_VERSION                           (DSI3->HW_VERSION.reg)
#define DSI3_HW_VERSION_bit                       (DSI3->HW_VERSION.bit)
