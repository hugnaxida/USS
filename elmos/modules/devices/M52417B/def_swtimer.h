 ...
 * -------------------------------------------------------------------
 * 18/08/28 (B) poe 1004 fixed wrong bit mask application for disabling autocycle
 * 18/08/08 (B) poe 1003 fixed shift position error and added timer count macro
 * 18/04/06 (F) poe 1002 added external src cfg
